...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AttachmentAv.AsyncS3ScanRequest();
  });
  ...
  describe('AsyncS3ScanRequest', function() {
    it('should create an instance of AsyncS3ScanRequest', function() {
      // uncomment below and update the code to test AsyncS3ScanRequest
      //var instance = new AttachmentAv.AsyncS3ScanRequest();
      //expect(instance).to.be.a(AttachmentAv.AsyncS3ScanRequest);
    });
